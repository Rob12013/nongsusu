    ...
    <div class="wrapper">
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <div class="item-price">元<span class="del">元</span></div>
          <div class="line"></div>
          <div class="item-addr">
            <i class="icon-loc"></i>
            <div class="addr"></div>
          ...
          <div class="item-version clearfix">
            <h2>选择版本</h2>
            <div class="phone fl" :class="{'checked':version==1}" @click="version=1"></div>
            <div class="phone fr" :class="{'checked':version==2}" @click="version=2"></div>
          </div>
          ...
          <div class="item-total">
            ...
            <div class="phone-total">总计：元</div>
          </div>
          <div class="btn-group">
